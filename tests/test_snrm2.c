...
extern float xsnrm2_(int*, float*, int*);

float f_snrm2(int n, float *x, int incx)
{
  return xsnrm2_(&n,x,&incx);
}
...
int main(int argc, char** argv) 
{
  ...
  printf("Running test for SNRM2 with N=%d\n",N);
  printf("%32s%32s\n","ACML","Fortran");
  printf("Trials\n");
