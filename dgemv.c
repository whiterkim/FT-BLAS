...
static void sgemv_kernel_16x4(BLASLONG n, DOUBLE **ap, DOUBLE *x, DOUBLE *y)
{
    BLASLONG i;
    DOUBLE *a0,*a1,*a2,*a3;
    a0 = ap[0];
...
static void sgemv_kernel_16x1(BLASLONG n, DOUBLE *ap, DOUBLE *x, DOUBLE *y)
{
    BLASLONG i;
    DOUBLE *a0;
    a0 = ap;
...
static void zero_y(BLASLONG n, DOUBLE *dest)
{
    BLASLONG i;
    for ( i=0; i<n; i++ )
    {
...
static void add_y(BLASLONG n, DOUBLE *src, DOUBLE *dest, BLASLONG inc_dest)
{
    BLASLONG i;
    if ( inc_dest == 1 )
    {
...
int CNAME(BLASLONG m, BLASLONG n, BLASLONG dummy1, DOUBLE alpha, DOUBLE *a, BLASLONG lda, DOUBLE *x, BLASLONG inc_x, DOUBLE *y, BLASLONG inc_y, DOUBLE *buffer)
{
    BLASLONG i;
    BLASLONG j;
    DOUBLE *a_ptr;
...
static void sgemv_kernel_16x4_2(BLASLONG n, DOUBLE **ap, DOUBLE *x, DOUBLE *y, DOUBLE *c)
{
    BLASLONG i;
    DOUBLE *a0,*a1,*a2,*a3;
    a0 = ap[0];
...
static void sgemv_kernel_16x1_2(BLASLONG n, DOUBLE *ap, DOUBLE *x, DOUBLE *y, DOUBLE *c)
{
    BLASLONG i;
    DOUBLE *a0;
    a0 = ap;
...
static void zero_y_2(BLASLONG n, DOUBLE *dest)
{
    /*BLASLONG i;
    for ( i=0; i<n; i++ )
    {
	...
	memset(dest, 0, sizeof(DOUBLE)*n);
}



static void add_y_2(BLASLONG n, DOUBLE *src, DOUBLE *dest, BLASLONG inc_dest)
{
    BLASLONG i;
    if ( inc_dest == 1 )
    {
...
int openCkm(BLASLONG m, BLASLONG n, BLASLONG dummy1, DOUBLE alpha, DOUBLE *a, BLASLONG lda, DOUBLE *x, BLASLONG inc_x, DOUBLE *y, BLASLONG inc_y, DOUBLE *buffer)
{
    BLASLONG i;
    BLASLONG j;
    DOUBLE *a_ptr;
...
void one(char trans, int m, int n, DOUBLE alpha, DOUBLE *A, int lda, DOUBLE *x, int incx, DOUBLE beta, DOUBLE *y, int incy)
{
