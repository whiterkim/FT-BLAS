...
static void sgemv_kernel_16x4(BLASLONG n, DOUBLECOMPLEX **ap, DOUBLECOMPLEX *x, DOUBLECOMPLEX *y)
{
    BLASLONG i;
    DOUBLECOMPLEX *a0,*a1,*a2,*a3;
    a0 = ap[0];
    a1 = ap[1];
    a2 = ap[2];
    a3 = ap[3];
...
static void sgemv_kernel_16x1(BLASLONG n, DOUBLECOMPLEX *ap, DOUBLECOMPLEX *x, DOUBLECOMPLEX *y)
{
    BLASLONG i;
    DOUBLECOMPLEX *a0;
    a0 = ap;
...
static void zero_y(BLASLONG n, DOUBLECOMPLEX *dest)
{
    BLASLONG i;
    for ( i=0; i<n; i++ )
    {
...
static void add_y(BLASLONG n, DOUBLECOMPLEX *src, DOUBLECOMPLEX *dest, BLASLONG inc_dest)
{
    BLASLONG i;
    if ( inc_dest == 1 )
    {
...
int CNAME(BLASLONG m, BLASLONG n, BLASLONG dummy1, DOUBLECOMPLEX alpha, DOUBLECOMPLEX *a, BLASLONG lda, DOUBLECOMPLEX *x, BLASLONG inc_x, DOUBLECOMPLEX *y, BLASLONG inc_y, DOUBLECOMPLEX *buffer)
{
    BLASLONG i;
    BLASLONG j;
    DOUBLECOMPLEX *a_ptr;
    ...
    BLASLONG m2;
    BLASLONG n2;
    DOUBLECOMPLEX xbuffer[4],*ybuffer;
...
static void sgemv_kernel_16x4_2(BLASLONG n, DOUBLECOMPLEX **ap, DOUBLECOMPLEX *x, DOUBLECOMPLEX *y, DOUBLECOMPLEX *c)
{
    BLASLONG i;
    DOUBLECOMPLEX *a0,*a1,*a2,*a3;
    a0 = ap[0];
	...
	DOUBLECOMPLEX t0, t1, t2, t3;
	DOUBLECOMPLEX x0, x1, x2, x3;
	DOUBLECOMPLEX c0, c1, c2, c3;
	c0 = c1 = c2 = c3 = 0;
...
static void sgemv_kernel_16x1_2(BLASLONG n, DOUBLECOMPLEX *ap, DOUBLECOMPLEX *x, DOUBLECOMPLEX *y, DOUBLECOMPLEX *c)
{
    BLASLONG i;
    DOUBLECOMPLEX *a0;
    a0 = ap;
...
static void zero_y_2(BLASLONG n, DOUBLECOMPLEX *dest)
{
    /*BLASLONG i;
    for ( i=0; i<n; i++ )
    {
	...
	memset(dest, 0, sizeof(DOUBLECOMPLEX)*n);
}



static void add_y_2(BLASLONG n, DOUBLECOMPLEX *src, DOUBLECOMPLEX *dest, BLASLONG inc_dest)
{
    BLASLONG i;
    if ( inc_dest == 1 )
    {
...
int openCkm(BLASLONG m, BLASLONG n, BLASLONG dummy1, DOUBLECOMPLEX alpha, DOUBLECOMPLEX *a, BLASLONG lda, DOUBLECOMPLEX *x, BLASLONG inc_x, DOUBLECOMPLEX *y, BLASLONG inc_y, DOUBLECOMPLEX *buffer)
{
    BLASLONG i;
    BLASLONG j;
    DOUBLECOMPLEX *a_ptr;
    ...
    DOUBLECOMPLEX *c = (DOUBLECOMPLEX*)malloc(sizeof(DOUBLECOMPLEX)*n);
    memset(c,0,sizeof(DOUBLECOMPLEX)*n);
    DOUBLECOMPLEX *c_ptr = c;
    DOUBLECOMPLEX cy = 0;
    for (i = 0; i < m; i++)
        cy += y[i];
...
void one(char trans, int m, int n, DOUBLECOMPLEX alpha, DOUBLECOMPLEX *A, int lda, DOUBLECOMPLEX *x, int incx, DOUBLECOMPLEX beta, DOUBLECOMPLEX *y, int incy)
{
    if ((m == 0) || (n == 0) || (alpha == 0 && beta == 1))
        return;
    int i, j;
    DOUBLECOMPLEX yi, cy = 0;

    //y = beta*y
    if (beta == 0)
        memset(y,0,sizeof(DOUBLECOMPLEX)*m);
    else //if (beta != 1)
        for (i = 0; i < m; i++)
        {
            yi = y[i]*beta;
...
int main(int argc, char *argv[])
{
    ...
    y = (DOUBLECOMPLEX*)malloc(sizeof(DOUBLECOMPLEX)*m);
    t = (DOUBLECOMPLEX*)malloc(sizeof(DOUBLECOMPLEX)*m);
    A = (DOUBLECOMPLEX*)malloc(sizeof(DOUBLECOMPLEX)*m*n);
	buffer = (DOUBLECOMPLEX*)malloc(sizeof(DOUBLECOMPLEX)*m*n);
    ...
    //printf("acm\n");//ACML version
    memcpy(y,t,sizeof(DOUBLECOMPLEX)*m);
